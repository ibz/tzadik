...
urlpatterns = patterns('',
                       ...
                       (r"^photo/browse/((?P<filter_keyword>[a-z]+)/(?P<filter>[0-9a-z-]+)/)?$", 'photoblog.views.browse'),
                       (r"^photo/categories/$", 'photoblog.views.categories'),
                       (r"^photo/locations/$", 'photoblog.views.locations'),
